...
public class ScreenVidaPessoal : MonoBehaviour
{
    ...
    private void atualizarDisplaySituacao(){
        ...
        if (sanidade < 25)
        {
            ...
            displayDescricaoSituacao.text = "Sua sanidade está em um estado crítico. Cuidado necessário para evitar morte ou insanidade.";
        ...
        else if (sanidade < 50)
        {
            ...
            displayDescricaoSituacao.text = "Sua sanidade está em um estado neutro. Cuidado necessário para evitar consequências graves.";
    ...
    private void atualizarDisplayAtividades(){
        ...
        displayStrees.text = "Variação Diária: " + (variacaoDiaria >= 0 ? "+" : "") +variacaoDiaria.ToString("F2") + "%" 
                             + "\nRecuperação Diária: " + (gameManager.GetRecuperacaoSanidade() + gameManager.GetBonusDescansoSanidade()) + "%";
    ...
    private void atualizarDicas(){
        string[] dicas = {
            ...
            "Dica: Faça atividades para reduzir o estresse, como exercícios na academia, terapia ou tirar um dia de folga.",
            "Dica: Evite tirar muitos dias de folga, pois isso pode afetar sua renda diária.",
            "Dica: A academia recupera não só sua sanidade, mas também sua saúde física.",
            "Dica: Aumente sua renda, pois isso evita estresse por conta da dívida.",
            "Dica: Melhore suas técnicas de trabalho para evitar desgaste."
        };
